...
//        }
    ...
    public Map<String, String> fillRequestData(Map<String, String> reqData) throws Exception {
    	...
    	reqData.put("appid", Util.APPID);
        reqData.put("mch_id", Util.MCHID);
        ...
        reqData.put("sign_type", WXPayConstants.MD5);
        reqData.put("sign", WXPayUtil.generateSignature(reqData, Util.WXAPI_KEY, SignType.MD5));
    ...
    public boolean isResponseSignatureValid(Map<String, String> reqData) throws Exception {
        ...
        return WXPayUtil.isSignatureValid(reqData, Util.WXAPI_KEY, SignType.MD5);
    }
