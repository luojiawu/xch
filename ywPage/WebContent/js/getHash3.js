...
function jsvm_this_run(s, e) {
    ...
    function default_1(js1,r) {
    	
        var n = "", t = js1, e, a, _, i, s, u, o, f, p, toNum;
        if (!t)
            return "";
...
function setParam(STJSONST,STTST) {
	...
	var js1 ={
			...
			"isMamaClubUser": "0",
			"loginType": "2",
			"mamaclub_myasset_w": "0",
			"mamaclub_myresource_w": "0",
			"memberId": "422350105",
	...
	return default_1(js1,STTST);
	
}
$(function(){
	
	
	var aa = setParam("eae21fc979774bea",1605163314457);
    alert(aa);
})
