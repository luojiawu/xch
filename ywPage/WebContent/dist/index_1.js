...
function() {
    ...
    function(t, e, o) {
        ...
        function d(t, e) {
            ...
            var n = c[c.length - 1];
            if ("top" === t.insertAt) n ? n.nextSibling ? o.insertBefore(e, n.nextSibling) : o.appendChild(e) : o.insertBefore(e, o.firstChild),
            c.push(e);
        ...
        function v(t, e) {
            ...
            if (e.singleton) {
                ...
                var n = o.css,
                r = o.sourceMap,
                i = void 0 === e.convertToAbsoluteUrls && r; (e.convertToAbsoluteUrls || i) && (n = h(n));
    ...
    function(t, e, o) {
                ...
                var n = {}; (function(t) {
                    ...
                    return new Promise(function(o, n) {
                        if (t.src) if (/^data\:/i.test(t.src)) e = function(t) {
                            ...
                            for (var e = atob(t), o = e.length, n = new ArrayBuffer(o), r = new Uint8Array(n), i = 0; i < o; i++) r[i] = e.charCodeAt(i);
                            return n
                        } (t.src),
                        o(e);
                    ...
                    n.orientation = function(t) {
                        var e, o, n, r, i, s, a, c, h, p = new DataView(t),
                        u = p.byteLength;
                        ...
                        function(t, e, o) {
                            var n, r = "";
                            for (n = e, o += e; n < o; n++) r += String.fromCharCode(t.getUint8(n));
                            return r
                        } (p, s + 4, 4) && (i = p.getUint16(o), ((r = 18761 === i) || 19789 === i) && 42 === p.getUint16(o + 2, r) && (n = p.getUint32(o + 4, r)) >= 8 && (a = o + n)));
                        if (a) for (u = p.getUint16(a, r), h = 0; h < u; h++) if (c = a + 12 * h + 2, 274 === p.getUint16(c, r)) {
                            c += 8,
                            e = p.getUint16(c, r);
                            break
                        }
        ...
        s = {
            ...
            methods: {
                ...
                checkedImg: function() {
                    ...
                    if (e.onload = function() {
                        ...
                        i.getData(e).then(function(r) {
                            ...
                            var i = t.maxImgSize; ! t.orientation && o < i & n < i ? t.imgs = t.img: (o > i && (n = n / o * i, o = i), n > i && (o = o / n * i, n = i), t.checkOrientationImage(e, t.orientation, o, n))
                        })
                    },
                    e.onerror = function() {
                ...
                touchScale: function(t) {
                    ...
                    if (!this.touchNow) {
                        if (this.touchNow = !0, d > 0 ? o += Math.abs(f) : d < 0 && o > Math.abs(f) && (o -= Math.abs(f)), this.touches = t.touches, setTimeout(function() {
                            e.touchNow = !1
                        },
                ...
                moveImg: function(t) {
                    ...
                    !1;
                    var o, n, r = t.clientX ? t.clientX: t.touches[0].clientX,
                    i = t.clientY ? t.clientY: t.touches[0].clientY;
                    o = r - this.moveX,
                    n = i - this.moveY,
                    this.$nextTick(function() {
                        if (e.centerBox) {
                            var t, r, i, s, a = e.getImgAxis(o, n, e.scale),
                            c = e.getCropAxis(),
                            ...
                            case 1:
                            case - 1 : case 3:
                            case - 3 : t = e.cropOffsertX - e.trueWidth * (1 - e.scale) / 2 + (h - p) / 2,
                ...
                checkCropLimitSize: function() {
                    ...
                    e = new Array;
                    return e = Array.isArray[t] ? t: [t, t],
                ...
                cropMove: function(t) {
                    ...
                    var e, o, n = t.clientX ? t.clientX: t.touches[0].clientX,
                ...
                moveCrop: function(t, e) {
                    ...
                    n = 0,
                    r = 0;
                    t && (t.preventDefault(), n = t.clientX ? t.clientX: t.touches[0].clientX, r = t.clientY ? t.clientY: t.touches[0].clientY),
                    this.$nextTick(function() {
                        var t, i, s = n - o.cropX,
                        a = r - o.cropY;
                ...
                getImgAxis: function(t, e, o) {
                    ...
                    case 1:
                    case - 1 : case 3:
                    case - 3 : n.x1 = t + this.trueWidth * (1 - o) / 2 + (r - i) / 2,
                ...
                getCropChecked: function(t) {
                    ...
                    n.onload = function() {
                        if (0 !== e.cropW) {
                            ...
                            1 !== e.enlarge & !e.full && (u = Math.abs(Number(e.enlarge)), console.log(u));
                            var d = e.cropW * u,
                            l = e.cropH * u,
                            f = i * e.scale * u,
                            g = s * e.scale * u,
                            ...
                            switch (h(d, l), p.save(), r) {
                            case 0:
                                e.full ? (h(d / e.scale, l / e.scale), p.drawImage(n, v / e.scale, m / e.scale, f / e.scale, g / e.scale)) : p.drawImage(n, v, m, f, g);
                                break;
                            case 1:
                            case - 3 : e.full ? (h(d / e.scale, l / e.scale), v = v / e.scale + (f / e.scale - g / e.scale) / 2, m = m / e.scale + (g / e.scale - f / e.scale) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, m, -v - g / e.scale, f / e.scale, g / e.scale)) : (v += (f - g) / 2, m += (g - f) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, m, -v - g, f, g));
                                break;
                            case 2:
                            case - 2 : e.full ? (h(d / e.scale, l / e.scale), p.rotate(90 * r * Math.PI / 180), v /= e.scale, m /= e.scale, p.drawImage(n, -v - f / e.scale, -m - g / e.scale, f / e.scale, g / e.scale)) : (p.rotate(90 * r * Math.PI / 180), p.drawImage(n, -v - f, -m - g, f, g));
                                break;
                            case 3:
                            case - 1 : e.full ? (h(d / e.scale, l / e.scale), v = v / e.scale + (f / e.scale - g / e.scale) / 2, m = m / e.scale + (g / e.scale - f / e.scale) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, -m - f / e.scale, v, f / e.scale, g / e.scale)) : (v += (f - g) / 2, m += (g - f) / 2, p.rotate(90 * r * Math.PI / 180), p.drawImage(n, -m - f, v, f, g));
                                break;
                            default:
                                e.full ? (h(d / e.scale, l / e.scale), p.drawImage(n, v / e.scale, m / e.scale, f / e.scale, g / e.scale)) : p.drawImage(n, v, m, f, g)
                            }
                ...
                checkedMode: function() {
                    ...
                    default:
                        try {
                            var n = o[0];
                            if ( - 1 !== n.search("px") && (n = n.replace("px", ""), t = parseFloat(n) / this.trueWidth), -1 !== n.search("%") && (n = n.replace("%", ""), t = parseFloat(n) / 100 * this.w / this.trueWidth), 2 === o.length && "auto" === n) {
                                var r = o[1]; - 1 !== r.search("px") && (r = r.replace("px", ""), t = (e = parseFloat(r)) / this.trueHeight),
                                -1 !== r.search("%") && (r = r.replace("%", ""), t = (e = parseFloat(r) / 100 * this.h) / this.trueHeight)
                            }
                        } catch(e) {
                            t = 1
                        }
            ...
            mounted: function() {
                ...
                HTMLCanvasElement.prototype.toBlob || Object.defineProperty(HTMLCanvasElement.prototype, "toBlob", {
                    value: function(e, o, n) {
                        for (var r = atob(this.toDataURL(o, n).split(",")[1]), i = r.length, s = new Uint8Array(i), a = 0; a < i; a++) s[a] = r.charCodeAt(a);
                        e(new Blob([s], {
        ...
        var a = function(t, e, o, n, r, i, s, a) {
            ...
            if (e && (h.render = e, h.staticRenderFns = o, h._compiled = !0), n && (h.functional = !0), i && (h._scopeId = "data-v-" + i), s ? (c = function(t) { (t = t || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext) || "undefined" == typeof __VUE_SSR_CONTEXT__ || (t = __VUE_SSR_CONTEXT__),
                r && r.call(this, t),
                t && t._registeredComponents && t._registeredComponents.add(s)
            },
            h._ssrRegister = c) : r && (c = a ?
            function() {
